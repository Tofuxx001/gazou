  ...
  return (
    <>
      <header className="w-full h-20 bg-white dark:bg-gray-900 px-8 flex items-center justify-between shadow-md">
        ...
        <nav className="item-self-end flex space-x-6 text-sm font-medium text-gray-700 dark:text-gray-200 items-center">
      ...
      <section
        id="updates"
        className="mt-12 px-6 py-10 bg-white dark:bg-gray-900 shadow-md rounded-lg max-w-5xl mx-auto">
      ...
      <section
        ...
        <div className="grid md:grid-cols-2 gap-8 text-gray-800 dark:text-gray-100 text-base leading-relaxed">
      ...
      <header className="flex items-center justify-between w-full h-20 bg-white dark:bg-gray-900 px-6 shadow-md mt-10">
        <div className="flex items-center space-x-4">
